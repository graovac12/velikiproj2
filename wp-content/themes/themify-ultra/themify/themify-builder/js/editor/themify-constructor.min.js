...
function(){this.removeEventListener("focusin",n,{once:!0,passive:!0});this.removeEventListener("tf_init",n,{once:!0,passive:!0});var r=m.safe,v=l.createDocumentFragment();const u=this.querySelector("select"),w=u.getElementsByTagName("optgroup");u.dataset.init=!0;if(void 0!==k)for(var y=w.length-1;-1<y;--y)for(;w[y].firstChild;)w[y].removeChild(w[y].lastChild);for(var C in r)y=l.createElement("option"),y.value=C,y.textContent=r[C],y.dataset.type="webfont",k===C&&(y.selected=!0),v.appendChild(y);w[q?
...
x=x.querySelectorAll("."+a.tax_id+",."+a.term_id+",."+a.tag_id);for(var G=x.length-1;-1<G;--G)x[G].classList.toggle("tf_hide",F)}x=void 0===a.tag_id?a.term_id.replace("#tmp_id#",D):a.tag_id;F=z.closest(".tb_input");var M;z.id=x;null===u&&void 0!==h[x]&&(M=h[x].split("|")[0]);M||(M=0);m(z,M,e.cacheTerms[B]);if(I||""===I)z.value=I;if(null===u){B=l.createElement("input");x=l.createElement("span");G=l.createElement("div");x.innerHTML=b.label.or;B.type="text";B.className="query_category_multiple";G.className=
...
dataset:"custom_fields",id:"query_cf_key",label:b.label.aq[4]},{id:"query_cf_value",label:b.label.aq[5],type:"text"},{id:"query_cf_c",label:b.label.aq[6],type:"select",options:{"":"LIKE","NOT LIKE":"NOT LIKE","NOT EXISTS":"NOT EXISTS","=":"=","!=":"!=",">":">",">=":">=","<":"<","<=":"<="}}],wrap_class:"tb_query_filter"+(b.values.query_cf_key?"":" tf_hide")}]);v.appendChild(y);if(!b.values.query_cf_key||!b.values.query_authors||!b.values.query_date_from&&!b.values.query_date_to){let z=l.createElement("div");
y=l.createElement("div");let D=l.createElement("div"),I=l.createElement("ul"),J=l.createElement("div"),K=l.createElement("span");if(!b.values.query_date_from&&!b.values.query_date_to){var C=l.createElement("li");C.innerText=b.label.aq[0];C.setAttribute("data-id","query_date");I.appendChild(C)}b.values.query_authors||(C=l.createElement("li"),C.innerText=b.label.aq[7],C.setAttribute("data-id","query_authors"),I.appendChild(C));b.values.query_cf_key||(C=l.createElement("li"),C.innerText=b.label.aq[3],
C.setAttribute("data-id","query_cf"),I.appendChild(C));z.className="tb_field";y.className="tb_input tf_rel";J.className="tb_label tb_empty_label";D.setAttribute("tabindex","-1");D.className="tb_ui_dropdown_label tb_sort_fields_plus";I.className="tb_ui_dropdown_items";K.innerText=b.label.aq[8];D.appendChild(K);z.appendChild(J);z.appendChild(y);y.appendChild(D);y.appendChild(I);v.appendChild(z);I.addEventListener("click",function(B){if("LI"===B.target.tagName){B.preventDefault();B.stopPropagation();
t.Utils.hideOnClick(this);let x=B.target.getAttribute("data-id");this.closest('.tb_field[data-type="query_posts"], .tb_field[data-type="advanced_posts_query"]').querySelector("."+x).classList.remove("tf_hide");B.target.style.display="none";B.target.removeAttribute("data-id");this.querySelector("[data-id]")||z.classList.add("tf_hide")}})}}c.parentNode.replaceChild(v,c);q=c=null})})();return c}},hook_content:{render(a,b){return b.create([{type:"group",label:b.label.hc[0],display:"accordion",options:[{id:"hook_content",
...
l.createElement("span"),u=l.createElement("span"),w=d[n].split(",");v.className="themify_tooltip";u.textContent=n.replace("-"," ");r.className="tb_position_item";r.setAttribute("data-pos",d[n]);r.style.left=w[0]+"%";r.style.top=w[1]+"%";v.appendChild(u);r.appendChild(v);k.appendChild(r)}m.addEventListener(e.mousedown,function(n){if("touchstart"===n.type||1===n.which){n.stopImmediatePropagation();let r,v;const u=this.ownerDocument,w=this,y=this.offsetLeft-(n.touches?n.touches[0].clientX:n.clientX),
C=this.offsetTop-(n.touches?n.touches[0].clientY:n.clientY),z=c.w,D=c.h,I=function(K){v=!0;u.body.classList.add("tb_start_animate","tb_move_drag")},J=function(K){K.stopImmediatePropagation();r&&cancelAnimationFrame(r);r=requestAnimationFrame(function(){let B=y+(K.touches?K.touches[0].clientX:K.clientX),x=C+(K.touches?K.touches[0].clientY:K.clientY);B>z?B=z:0>B&&(B=0);x>D?x=D:0>x&&(x=0);w.style.left=B+"px";w.style.top=x+"px";c.changeUpdate(w,B,x)})};u.addEventListener(e.mouseup,function(K){this.removeEventListener(e.mousemove,
...
w=e.getAttribute("data-unit");let y=e.value;y=k?y?y.split(","):[v,u]:y?y:m;n.className="tb_slider_label_l";r.className="tb_slider_label_u";v={range:k,min:v,max:u,slide:function(C,z){k?(n.textContent=z.values[0]+w,r.textContent=z.values[1]+w):n.textContent=z.value+w},create(C,z){C=this.getElementsByClassName("ui-slider-handle");k?(n.textContent=y[0]+w,C[0].appendChild(n),r.textContent=y[1]+w,C[1].appendChild(r)):(n.textContent=y+w,C[0].appendChild(n));y=null},change:function(C,z){e.value=k?z.values[0]+
","+z.values[1]:z.value}};k?v.values=y:v.value=y;H.jQuery.fn.slider.call(A(q),v)};b.afterRun.push(function(){H.Themify.LoadAsync(themifyBuilder.includes_url+"js/jquery/ui/slider.min.js",function(){p(d)},themify_vars.version,null,function(){return void 0!==H.jQuery.fn.slider})});return c}},range:{update(a,b,c){const d=c.getEl(a);null!==d&&(d.value=void 0!==b?b:"",b=a+"_unit",a=H.document.getElementById(b),null!==a&&"SELECT"===a.tagName&&(c=c.getStyleVal(b),void 0===c&&(c=a[0].value),a.value=c,this.setData(d,
